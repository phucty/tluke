VOCAB=1k
DATA="data/tluke_pretraining_roberta_base_${VOCAB}/"
GPUS=1
PRETRAIN=models/tluke_roberta_base
STAGE1="pretraining_config/tluke_base_${VOCAB}_stage1.json"
STAGE2="pretraining_config/tluke_base_${VOCAB}_stage2.json"
BERT="roberta-base"
EPOCH1=1
EPOCH2=1
PRETRAIN_INIT=models/luke-base/pytorch_model.bin
