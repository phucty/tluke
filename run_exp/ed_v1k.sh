deepspeed \
    ...
    --output-dir=models/tluke_bert_large_1k \
    --deepspeed-config-file=pretraining_config/tluke_large_stage1.json \
    --dataset-dir=data/tluke_pretraining_bert_large_1k/ \
...
deepspeed \
    ...
    --reset-optimization-states \
    --from-tables \
    --resume-checkpoint-id=models/tluke_bert_large_1k/checkpoints/epoch6

cp models/tluke_bert_large_1k/checkpoints/epoch6/mp_rank_00_model_states.pt models/tluke_ed_large/pytorch_model.bin
cp models/tluke_bert_large_1k/metadata.json models/tluke_ed_large/metadata.json
